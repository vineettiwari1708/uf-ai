...
submitBtn.addEventListener('click', () => {
    ...
    if (submitBtn.disabled) return; // 🔥 safety fix
    ...
    for (let question in userAnswers) {
        formattedAnswers += question + ": " + userAnswers[question] + "\n";
    }

    localStorage.setItem("ai_quiz_answers", formattedAnswers);

    window.location.href = "https://urbanfeatconstruction.com/aiufp/";
});
submitBtn.addEventListener('click', () => {
